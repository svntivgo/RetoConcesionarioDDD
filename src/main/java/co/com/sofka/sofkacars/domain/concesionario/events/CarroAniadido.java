...
public class CarroAniadido extends DomainEvent {
    ...
    public CarroAniadido(CarroId carroId, Marca marca, Modelo modelo, Color color, Precio precio) {
        super("RetoConcesionarioDDD.CarroAniadido");
