...
public class CambiarCarro extends Command {
    ...
    public CambiarCarro(ConcesionarioId concesionarioId,CarroId carroId, Marca marca, Modelo modelo, Color color, Precio precio) {
